"""
Implementation of  LaneNet's Discriminative Loss function using the paper "https://arxiv.org/abs/1708.02551"
"""
...
def discriminative_loss_single(
        ...
        param_reg):
    """
    :param prediction: inference of network obtained using CNN
    :param correct_label: instance label truth value
    :param feature_dim: feature dimension of prediction
    :param label_shape: shape of instance label
    ...
    # Calculate the loss(var) of the formula
...
def discriminative_loss(prediction, correct_label, feature_dim, image_shape,
    ...
    """
    Iteratively calculate the loss loss according to the idea of ​​the paper
